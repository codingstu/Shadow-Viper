  ...
  <n-config-provider :theme="darkTheme" :theme-overrides="themeOverrides">
    ...
    <div class="h-screen w-full bg-[#121212] text-gray-200 flex flex-col p-2 md:p-4 overflow-hidden font-mono">
      ...
      <div class="flex items-center gap-3 pl-2 pr-4">
        <div class="p-1.5 bg-gradient-to-br from-purple-500/20 to-indigo-500/20 rounded-full border border-purple-500/30">
          <span class="text-lg">🕷️</span>
        </div>
        <div class="flex flex-col leading-none">
          <h1 class="text-sm font-bold text-white m-0">Viper 爬虫</h1>
          <span class="text-[10px] text-purple-400 font-mono scale-90 origin-left">Spider System</span>
        </div>
      </div>
      </div>
