          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              <h1 class="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-fuchsia-400">
                Game Generator <span class="text-xs bg-violet-900/30 text-violet-300 px-2 py-0.5 rounded ml-1 border border-violet-500/30 align-middle">3D Ready</span>
              </h1>
            </div>
          </div>
          ...
          <div class="flex-1 overflow-y-auto p-2 custom-scrollbar space-y-2">
            ...
            >
              <div class="flex items-start gap-2">
                <div class="text-xs px-1.5 py-0.5 rounded border mt-0.5"
                  :class="item.game_type === '3d' 
        ...
        <div class="flex-1 flex flex-col bg-[#1e1e1e] rounded-xl border border-gray-800 shadow-xl overflow-hidden">
          ...
          <div class="flex-1 relative bg-black overflow-hidden">
            <div v-show="viewMode === 'preview'" class="w-full h-full relative">
              ...
              <!-- 错误提示 -->
              <div v-if="iframeError && generatedHtml" class="absolute inset-0 flex flex-col items-center justify-center bg-red-900/10 backdrop-blur-sm">
          ...
          <div class="p-4 bg-[#252525] border-t border-gray-700 shrink-0">
            ...
            <div class="mt-2 text-xs text-gray-500 flex justify-between">
              <span>当前引擎：<span :class="gameType === '3d' ? 'text-blue-400' : 'text-violet-400'">{{ gameType === '3d' ? 'Three.js (3D)' : 'Phaser (2D)' }}</span></span>
